...
void ggml_cuda_mul_mat_q(
        ...
        if (entry != nullptr) {
            ...
            cache.add_entry(
                ...
                ggml_cuda_cache::cache_entry{
                    ggml_cuda_cache::cache_type::QUANTIZE_Q8_1,
                    layout,
                    std::move(allocs),
                    ctx.node_count + 10
                });
    ...
    if (entry != nullptr) {
        ...
        // Stored in allocation order
        ids_src1_ptr = entry->pool_ptrs[0].ptr;
